...
const {doctors} = useContext(AppContext)
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gary-900 md:mx-10'>
        ...
        <p className='sm:w-1/3 text-center text-sm'>Simply browse through our exstensive list of trusted Doctors.</p>
        <div className='w-full grid grid-cols-auto gap-4 pt-5gap-y-6 px-3 sm:px '>
            ...
            <div onClick={()=>navigate('/appointment/${item._id}')} className='border border-blue-200 rounded-xl overflow-hidden cursor-pointer hover:-translate-y-2 transition-all duration-500' key={index}>
                ...
                <div className='p-4'>
                    <div className='flex items-center gap-2 text-sm text-center text-green-500'>
                        <p className='w-2 h-2 bg-green-500 rounded-full'></p><p>Psychologist</p>
                    </div>
